...
const Hero = () => {
    ...
    return (
        <div onMouseMove={handleMouseMove} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="w-full h-screen relative overflow-hidden">
            <div ref={cursor} onClick={handelClick} className="w-[8vw] h-[8vw] bg-[#1d1d1db1] rounded-full flex justify-center items-center absolute z-[1]"
                style={{
            ...
            // }}
            >
                <h5 className="pointer-events-none select-none text-white">Play Reel</h5>
            </div>
